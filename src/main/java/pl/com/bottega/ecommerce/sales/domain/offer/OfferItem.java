...
public class OfferItem {
  ...
  public OfferItem(ProductData productData, int quantity, Discount discount) {
    ...
    if (discount != null) discountValue = discountValue.subtract(discount.getValue());
  ...
  public boolean equals(Object obj) {
    ...
    if (productData == null) {
      if (other.productData != null) return false;
    } else if (!productData.equals(other.productData)) return false;
  ...
  public boolean sameAs(OfferItem item, double delta) {
    if (!productData.equals(item.productData)) return false;
